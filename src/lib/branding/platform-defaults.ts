...
export function getPlatformBrandingDefaults(): ResolvedOrganizationBranding {
  return {
    ...
    logoUrl: BRANDING_ASSETS.logoHorizontalTransparent,
    logoLightUrl: BRANDING_ASSETS.logoHorizontalTransparent,
    logoDarkUrl: BRANDING_ASSETS.logoHorizontalOnLight,
    logoHorizontalUrl: BRANDING_ASSETS.logoHorizontalTransparent,
    iconUrl: BRANDING_ASSETS.logoHorizontalTransparent,
