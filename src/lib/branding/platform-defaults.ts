...
export function getPlatformBrandingDefaults(): ResolvedOrganizationBranding {
  return {
    ...
    logoUrl: BRANDING_ASSETS.uiIcon,
    logoLightUrl: BRANDING_ASSETS.uiLogoLight,
    logoDarkUrl: BRANDING_ASSETS.uiLogoLight,
    logoHorizontalUrl: BRANDING_ASSETS.uiLogoHorizontal,
    iconUrl: BRANDING_ASSETS.uiIcon,
