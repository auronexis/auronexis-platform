  ...
  sections: [
    {
      ...
      paragraphs: [
        ...
        "Clients are always scoped to your organization. A client record is the anchor for reports, risks, incidents, monitoring connectors, and client portal access. Archiving a client preserves operational history and is the preferred offboarding path. Permanent hard delete is restricted to owners and admins after archive and removes associated operational CRM records through intended cascade paths; organization billing and invoice records are not client-cascaded. Formal GDPR erasure requests follow Compliance workflows rather than ordinary Clients delete.",
