...
export const BILLING_DOC: DocPageInput = {
  ...
  title: "Billing",
  description:
    "Plans, Paddle checkout, invoices, payment methods, and subscription management.",
  intro:
    "Billing is managed in Settings → Billing. Workspace owners and admins with billing permissions can compare plans, start Paddle checkout, download invoices, update payment methods, and open the Paddle customer portal to manage subscriptions.",
  callouts: [
    {
      variant: "info",
  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "Customer portal — Paddle's hosted page for payment methods, invoices, and subscription management.",
        ...
        "Invoice — a billing document generated by Paddle for each charge, available as PDF from Settings → Billing or the customer portal.",
      ],
      paragraphs: [
        "Plan changes and payment events are reflected in Settings → Billing after Paddle confirms the transaction. There may be a short delay between completing checkout and seeing the updated plan in the dashboard. Payment card details never appear in Auroranexis — they are entered and stored entirely within Paddle's secure checkout and customer portal flows.",
      ],
    },
    {
      title: "Features",
      bullets: [
        ...
        "Paddle checkout — secure, hosted payment flow for new subscriptions and upgrades.",
      ...
      subsections: [
        ...
        },
        {
          ...
          paragraphs: [
            "Payment methods are managed exclusively through the Paddle customer portal. You can add credit or debit cards, set a default method, and remove expired cards without exposing card numbers in the Auroranexis dashboard. Invoices for each billing period appear in Settings → Billing with payment status, and full history including PDF downloads is available in the customer portal.",
          ],
        },
      ],
    },
    {
      ...
      subsections: [
        {
          title: "Subscribe or upgrade via Paddle checkout",
          ordered: [
            ...
            "Click the upgrade or subscribe action to start Paddle checkout.",
            "Enter payment details on the secure Paddle checkout page.",
        ...
        },
        {
          ...
          ordered: [
            ...
            "For older invoices, open the Paddle customer portal for the full billing history.",
          ],
        },
        {
          ...
          ordered: [
            ...
            "In the Paddle customer portal, add a new card or replace an existing payment method.",
        ...
        },
        {
          ...
          ordered: [
            "Open Settings → Billing and launch the Paddle customer portal.",
    ...
    },
    {
      ...
      bullets: [
        ...
        "Ensure your billing email address receives Paddle invoice and failure notifications.",
      ...
      table: {
        ...
        rows: [
          [
            ...
            "Paddle confirmation may still be processing",
          ...
          [
            ...
            "Open the Paddle customer portal from Settings → Billing and update your default payment method immediately.",
          ],
          [
  ...
  faq: [
    {
      ...
      answer:
        "Workspace owners and admins with billing permissions can change plans, apply discount codes, and open the Paddle customer portal. Other roles cannot modify subscription or payment settings.",
    },
    {
      question: "Where are my payment details stored?",
      answer:
        "Payment card and bank details are collected and stored by Paddle, not in Auroranexis application databases. The billing page shows subscription status without exposing sensitive payment data.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Open Settings → Billing to view recent invoices and download PDFs. The Paddle customer portal provides the full invoice history.",
    },
    {
      question: "What is the difference between Business and Enterprise?",
      answer:
        "Business is a self-serve tier with expanded limits and features available through Paddle checkout. Enterprise involves a reviewed request process with custom limits, onboarding, and negotiated terms submitted from Settings → Enterprise or Settings → Billing.",
    },
    {
...
export const SECURITY_DOC: DocPageInput = {
  ...
  intro:
    "Auroranexis is designed for agency operations with organization-scoped data, role-based access control, encrypted transport and storage, and secure billing through Paddle. This page describes security controls available to customers — not internal platform infrastructure.",
  callouts: [
    {
      variant: "warning",
  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "Secure billing — payment details are handled entirely by Paddle; Auroranexis never stores card numbers.",
    ...
    },
    {
      ...
      subsections: [
        ...
        },
        {
          ...
          bullets: [
            "Payment card and bank details are collected and stored by Paddle — not in Auroranexis databases.",
            "Billing pages display subscription status without exposing card numbers or CVV data.",
            "Only authorized roles can initiate checkout or open the Paddle customer portal.",
          ],
        },
      ],
    },
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        "Payment card and bank details are stored by Paddle, a PCI-compliant merchant of record. Auroranexis does not store card numbers or CVV data in application databases.",
      },
      {
        question: "Can staff members access billing settings?",
        answer:
          "Only workspace owners and admins with billing permissions can manage subscriptions and open the Paddle customer portal. Staff and viewer roles cannot modify billing settings.",
      },
    {
  ...
  sections: [
    {
      ...
      paragraphs: [
        ...
        "Unlike self-serve plan upgrades through Paddle checkout, enterprise onboarding involves a review process. Once approved, plan overrides and support contacts are applied to your workspace and visible in Settings → Enterprise and Settings → Billing.",
    ...
    },
    {
      ...
      bullets: [
        ...
        "Flexible billing arrangements negotiated outside standard Paddle checkout where applicable.",
      ...
      table: {
        ...
        rows: [
          ...
          [
            ...
            "Plan changes through Paddle may not reflect negotiated terms",
