...
export const SEARCH_INTENT_CLUSTERS: readonly SearchIntentCluster[] = [
  ...
  },
  {
    ...
    persona: "Account / delivery teams publishing client reports",
    funnelStage: "consideration",
    productFit: "high",
  },
  {
    id: "agency-operations-automation",
    label: "Agency operations automation software",
    primaryPath: FEATURE_ROUTES.automation,
    supportingPaths: [
      FEATURE_ROUTES.monitoring,
      USE_CASE_ROUTES.automationAgencies,
      MARKETING_ROUTES.features,
    ],
    persona: "Automation agencies and multi-client operators",
    funnelStage: "consideration",
    productFit: "high",
  },
  {
    id: "portfolio-profitability-reporting",
    label: "Client and portfolio profitability reporting",
    primaryPath: FEATURE_ROUTES.profitability,
    supportingPaths: [
      FEATURE_ROUTES.executiveDashboards,
      FEATURE_ROUTES.customerSuccess,
      "/docs/profitability",
    ],
    persona: "Managing partners / ops-finance",
    funnelStage: "consideration",
    productFit: "high",
  },
  {
    id: "executive-portfolio-dashboard",
    label: "Executive portfolio dashboard",
    primaryPath: SOLUTION_ROUTES.executiveDashboard,
    supportingPaths: [FEATURE_ROUTES.executiveDashboards, MARKETING_ROUTES.solutions],
    persona: "COOs / operations VPs",
    funnelStage: "consideration",
    productFit: "high",
  },
  {
    id: "msp-operations-persona",
    label: "MSP portfolio operations",
    primaryPath: USE_CASE_ROUTES.msps,
    supportingPaths: [
      USE_CASE_ROUTES.itServiceProviders,
      INDUSTRY_ROUTES.it,
      MARKETING_ROUTES.useCases,
    ],
    persona: "MSP owners and service delivery managers",
    funnelStage: "awareness",
    productFit: "high",
  },
  {
    id: "marketing-agency-persona",
    label: "Marketing agency client operations",
    primaryPath: USE_CASE_ROUTES.marketingAgencies,
    supportingPaths: [
      INDUSTRY_ROUTES.marketing,
      USE_CASE_ROUTES.digitalAgencies,
      MARKETING_ROUTES.useCases,
    ],
    persona: "Marketing agency operators",
    funnelStage: "awareness",
    productFit: "high",
  },
  {
    id: "resources-authority-hub",
    label: "Operations resources hub",
    primaryPath: MARKETING_ROUTES.resources,
    supportingPaths: [
