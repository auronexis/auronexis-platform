      ...
      <div className="space-y-6">
        ...
        {canManagePortal ? (
          <div className="rounded-2xl border border-border-subtle bg-surface-1 p-6 shadow-sm">
            <h2 className="text-sm font-semibold text-navy-950">Client portal access</h2>
            <p className="mt-1 text-sm text-muted">
              Create and disable client portal users from each client profile. Portal login:{" "}
              <span className="font-medium text-navy-950">/client-portal/login</span>
            </p>
            <Link
              href="/clients"
              className="mt-3 inline-flex text-sm font-medium text-accent-blue hover:underline"
            >
              Manage from clients
            </Link>
          </div>
