    ...
    <form action={formAction} className="space-y-3 rounded-md border border-border bg-muted/10 p-4">
      ...
      <div className="space-y-1.5">
        ...
        <textarea
          ...
          className="flex w-full rounded-md border border-border bg-surface-1 px-3 py-2 text-sm text-navy-950 placeholder:text-muted focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-blue"
        />
      </div>
