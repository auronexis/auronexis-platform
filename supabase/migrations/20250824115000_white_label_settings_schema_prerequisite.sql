-- Idempotent white-label schema prerequisite for production repair.
-- Ensures public.white_label_settings + RLS + storage exist before
-- 20250824120000_white_label_settings_delete_policy.sql.
-- Safe on fresh DBs, environments that missed 20250624110000, and DBs where the table already exists.
