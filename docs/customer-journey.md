...
| 9 | Billing upgrade | `/settings/billing` | Owner | FastSpring Checkout (test/live storefront) |
...
Manual only: FastSpring checkout, OAuth connect, portal invite acceptance.
